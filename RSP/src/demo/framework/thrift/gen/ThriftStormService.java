...
public class ThriftStormService {

  public interface Iface {

    public String update(String updateKeys) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void update(String updateKeys, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.update_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public String update(String updateKeys) throws org.apache.thrift.TException
    {
      send_update(updateKeys);
      return recv_update();
    }

    public void send_update(String updateKeys) throws org.apache.thrift.TException
    {
      update_args args = new update_args();
      args.setUpdateKeys(updateKeys);
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void update(String updateKeys, org.apache.thrift.async.AsyncMethodCallback<update_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      update_call method_call = new update_call(updateKeys, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class update_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public update_call(String updateKeys, org.apache.thrift.async.AsyncMethodCallback<update_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static class update<I extends Iface> extends org.apache.thrift.ProcessFunction<I, update_args> {
      ...
      protected update_result getResult(I iface, update_args args) throws org.apache.thrift.TException {
        update_result result = new update_result();
        result.success = iface.update(args.updateKeys);
        return result;
      }
    }
  ...
  public static class update_args implements org.apache.thrift.TBase<update_args, update_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private static final org.apache.thrift.protocol.TField UPDATE_KEYS_FIELD_DESC = new org.apache.thrift.protocol.TField("updateKeys", org.apache.thrift.protocol.TType.STRING, (short)1);
    ...
    public String updateKeys; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      UPDATE_KEYS((short)1, "updateKeys");
    ...
    static {
      ...
      tmpMap.put(_Fields.UPDATE_KEYS, new org.apache.thrift.meta_data.FieldMetaData("updateKeys", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    public update_args setUpdateKeys(String updateKeys) {
      this.updateKeys = updateKeys;
      return this;
    }

    public void unsetUpdateKeys() {
      this.updateKeys = null;
    }

    /** Returns true if field updateKeys is set (has been assigned a value) and false otherwise */
    public boolean isSetUpdateKeys() {
      return this.updateKeys != null;
    }

    public void setUpdateKeysIsSet(boolean value) {
      if (!value) {
        this.updateKeys = null;
      }
    }
    ...
    public boolean equals(update_args that) {
      ...
      boolean this_present_updateKeys = true && this.isSetUpdateKeys();
      boolean that_present_updateKeys = true && that.isSetUpdateKeys();
      if (this_present_updateKeys || that_present_updateKeys) {
        if (!(this_present_updateKeys && that_present_updateKeys))
          return false;
        if (!this.updateKeys.equals(that.updateKeys))
          return false;
      }
    ...
    public int compareTo(update_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetUpdateKeys()).compareTo(typedOther.isSetUpdateKeys());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetUpdateKeys()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.updateKeys, typedOther.updateKeys);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      sb.append("updateKeys:");
      if (this.updateKeys == null) {
        sb.append("null");
      } else {
        sb.append(this.updateKeys);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class update_argsStandardScheme extends StandardScheme<update_args> {
          ...
          switch (schemeField.id) {
            case 1: // UPDATE_KEYS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
                struct.updateKeys = iprot.readString();
                struct.setUpdateKeysIsSet(true);
              } else { 
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, update_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.updateKeys != null) {
          oprot.writeFieldBegin(UPDATE_KEYS_FIELD_DESC);
          oprot.writeString(struct.updateKeys);
          oprot.writeFieldEnd();
        }
